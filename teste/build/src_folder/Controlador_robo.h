...
private:
	...
	double fator_croda = 1.0049;// 1.005 maior pende p esquerda
	double delay = 5.0;//Em miliseg
	double aceleracao = 700.0;//Em pwm/seg
	double raio_roda = 0.029695;//0.0538/2.0; // metros
	double tamanho_do_pintao = 0.1265; // 0.062 melhor
	double relacao_engrenagem = 0.5; // 2 volta motor equivale 1 voltas roda
	double raio_robo = 0.1712/2.0; // largura entre os centros das rodas div por 2 0.132

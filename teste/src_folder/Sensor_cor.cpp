...
void Sensor_cor::calibra(){
	...
	r_Branco.r[0] = get<0>(rgb_Branco) - RangesCor::range_branco;
	r_Branco.r[1] = get<0>(rgb_Branco) + RangesCor::range_branco;
	r_Branco.g[0] = get<1>(rgb_Branco) - RangesCor::range_branco;
	r_Branco.g[1] = get<1>(rgb_Branco) + RangesCor::range_branco;
	r_Branco.b[0] = get<2>(rgb_Branco) - RangesCor::range_branco;
	r_Branco.b[1] = get<2>(rgb_Branco) + RangesCor::range_branco;
